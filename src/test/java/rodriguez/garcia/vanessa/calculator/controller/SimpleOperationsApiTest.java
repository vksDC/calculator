...
class SimpleOperationsApiTest {
	...
	void calculateAddSuccessfullyTest() throws Exception {
		...
		final OperationResultDto expectedResponse = new OperationResultDto()
				.code(OPERATION_ADD)
				.operators(operators)
		...
		final OperationResultDto response = TestUtils.performCallAndObtainOkResponse(mvc, mockRequest, OperationResultDto.class);
